...
// Keyframes
float posX = PosIni.x, posY = PosIni.y, posZ = PosIni.z, rotRodIzq = 0, rotRodDer, rotCodIzq, rotCodDer; 
...
void saveFrame(void)
{
	...
	KeyFrame[FrameIndex].rotCodIzq = rotCodIzq;
	KeyFrame[FrameIndex].rotCodDer = rotCodDer;
